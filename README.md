...
```bash
npx create-asd --example with-docker-compose with-docker-compose-app
```

```bash
yarn create asd --example with-docker-compose with-docker-compose-app
```

```bash
pnpm create asd --example with-docker-compose with-docker-compose-app
```
